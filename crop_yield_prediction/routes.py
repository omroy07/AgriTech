...
yield_bp = Blueprint('yield', __name__, template_folder='crop_yield_prediction/crop_yield_app/templates', static_folder='crop_yield_prediction/crop_yield_app/static')
...
def predict():
    try:
        ...
        return render_template('index.html', crop=crop, params=params, prediction=prediction)

    except ValueError as e:
        return render_template('input.html', error=str(e))
    except Exception as e:
        yield_bp.logger.error(f"Prediction error: {str(e)}")
